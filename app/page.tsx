  ...
  return (
    <main className="min-h-screen bg-background text-foreground selection:bg-primary selection:text-primary-foreground">
      ...
      <section id="top" className="mx-auto grid max-w-7xl gap-3 px-5 pb-14 lg:grid-cols-[1.05fr_.95fr] lg:px-8 lg:pb-24">
        ...
        <div className="relative min-h-[470px] overflow-hidden border-2 border-foreground bg-muted lg:min-h-[620px]"><div className="absolute left-5 top-5 z-10 flex items-center gap-2 rounded-full bg-background/90 px-3 py-2 text-[10px] font-semibold uppercase tracking-[0.16em] text-foreground"><Star className="size-3 fill-primary text-primary" /> Staff favorite</div><Image src="https://images.unsplash.com/photo-1618220179428-22790b461013?auto=format&fit=crop&w=1400&q=90" alt="Warm, sunlit interior with considered objects" fill className="object-cover" priority sizes="(max-width: 1024px) 100vw, 50vw" /></div>
      </section>
